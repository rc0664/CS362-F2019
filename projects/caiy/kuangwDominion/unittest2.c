...
b = minionCard(0, 1, 0, 0, &G);//It is not working. I don't know why, but the input functions should be correct. int case_minion(int currentPlayer, int choice1, int choice2, int handPos, struct gameState *state)
/*	
