...
int main()
{
	...
	b = case_ambassador(0, 0, 2, 2, &G); //choice1=0 to be different from handpos of 2.  Choose an estate.
	...
	b = case_ambassador(0, 0, 1, 2, &G); //handpos is 5, it is an estate. 
	...
	b = case_ambassador(0, 0, 3, 2, &G); //choice2 >2 exception
	if (b == -1)
	...
	b = case_ambassador(0, 0, -1, 2, &G); //choice2 <0 exception
	if (b == -1)
	...
	b = case_ambassador(0, 2, 1, 2, &G); //choice1 == handpos
	if (b == -1)
